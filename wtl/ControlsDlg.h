...
//		LPCTSTR str = CHotKeyCtrl::GetWndClassName();//"msctls_hotkey32"
		...
		m_LeftKey1.SetHotKey((WORD)m_pDoc->m_LeftKey1, WORD(m_pDoc->m_LeftKey1/255));
		m_RightKey1.SetRules(wInvalidComb, 0);
		m_RightKey1.SetHotKey((WORD)m_pDoc->m_RightKey1, WORD(m_pDoc->m_RightKey1/255));
		m_DownKey1.SetRules(wInvalidComb, 0);
		m_DownKey1.SetHotKey((WORD)m_pDoc->m_DownKey1, WORD(m_pDoc->m_DownKey1/255));
		m_RotateKey1.SetRules(wInvalidComb, 0);
		m_RotateKey1.SetHotKey((WORD)m_pDoc->m_RotateKey1, WORD(m_pDoc->m_RotateKey1/255));
		m_DropKey1.SetRules(wInvalidComb, 0);
		m_DropKey1.SetHotKey((WORD)m_pDoc->m_DropKey1, WORD(m_pDoc->m_DropKey1/255));

		m_LeftKey2.SetRules(wInvalidComb, 0);
		m_LeftKey2.SetHotKey((WORD)m_pDoc->m_LeftKey2, WORD(m_pDoc->m_LeftKey2/255));
		m_RightKey2.SetRules(wInvalidComb, 0);
		m_RightKey2.SetHotKey((WORD)m_pDoc->m_RightKey2, WORD(m_pDoc->m_RightKey2/255));
		m_DownKey2.SetRules(wInvalidComb, 0);
		m_DownKey2.SetHotKey((WORD)m_pDoc->m_DownKey2, WORD(m_pDoc->m_DownKey2/255));
		m_RotateKey2.SetRules(wInvalidComb, 0);
		m_RotateKey2.SetHotKey((WORD)m_pDoc->m_RotateKey2, WORD(m_pDoc->m_RotateKey2/255));
		m_DropKey2.SetRules(wInvalidComb, 0);
		m_DropKey2.SetHotKey((WORD)m_pDoc->m_DropKey2, WORD(m_pDoc->m_DropKey2/255));
